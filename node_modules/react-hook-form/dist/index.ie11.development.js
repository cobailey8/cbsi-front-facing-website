...
function useForm(_a) {
  ...
  React.useEffect(function () {
    ...
    return function () {
      ...
      fieldsRef.current && "development" === 'production' && _forEachInstanceProperty(_context24 = _Object$values(fieldsRef.current)).call(_context24, function (field) {
...
var fillEmptyArray = function (value) {
  ...
  return isArray(value) ? _fillInstanceProperty(_context25 = Array(value.length)).call(_context25, undefined) : undefined;
};
...
var filterBooleanArray = function (value) {
  ...
  return isArray(value) ? _flatInstanceProperty(_context26 = _mapInstanceProperty(value).call(value, mapValueToBoolean)).call(_context26) : mapValueToBoolean(value);
};
...
var mapIds = function (data, keyName) {
  ...
  return _mapInstanceProperty(_context27 = isArray(data) ? data : []).call(_context27, function (value) {
...
var useFieldArray = function (_a) {
  ...
  var getCurrentFieldsValues = function () {
    ...
    return _mapInstanceProperty(_context28 = get(getValues() || {}, name, allFields.current)).call(_context28, function (item, index) {
  ...
  var remove = function (index) {
    ...
    if (readFormStateRef.current.isValid && !validateSchemaIsValid) {
      ...
      while (fieldIndex++ < fields.length) {
        ...
        var isCurrentIndex = _indexOfInstanceProperty(_context29 = isArray(index) ? index : [index]).call(_context29, fieldIndex) >= 0;
